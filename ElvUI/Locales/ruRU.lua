...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-WotLK/ElvUI"] = "Ваш ElvUI устарел более, чем на 5 версий. Обновите его на https://discord.gg/bfcYWgDHt8"
...
L["Key"] = "Клавиша"
L["Search"] = "Поиск"
L["LOGIN_MSG"] = "Добро пожаловать в %sElvUI|r версии %s%s|r, наберите /ec для доступа в меню настроек. Если Вам нужна техническая поддержка присоединяйтесь к серверу Discord: https://discord.gg/bfcYWgDHt8"
...
L["RandomWords"] = { ---- не может быть только одной записи рандомные цитаты
	...
	"Хотите добавить свою смешную цитату? Пишите в https://discord.gg/bfcYWgDHt8",
